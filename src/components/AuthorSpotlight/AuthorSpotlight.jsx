...
const AuthorSpotlight = () => {
    ...
    return (
        <div>
            ...
            {
                authors.map(author => (
                <div key={ author } className="border border-textColor/15 rounded-2xl p-6 flex flex-col lg:flex-row gap-6 justify-between lg:items-center text-textColor/80 font-medium text-base hover:bg-hover hover:shadow-xl">
                    ...
                    <div className="carousel carousel-center max-w-lg space-x-4 bg-gradient p-4 rounded-box">
