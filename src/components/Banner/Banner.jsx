...
const Banner = () => {
    return (
        <div className="p-6 lg:py-24 lg:px-28 rounded-3xl mt-6 lg:mt-14 mb-12 lg:mb-24 circle relative">
            <div className="absolute top-1/2 left-[40%] w-[25%] h-[15%] lg:w-[20%] lg:h-[40%] blur-2xl bg-green rounded-full mix-blend-multiply animate-blob filter opacity-70  animation-delay-3000"></div>
            <div className="absolute top-1/3 left-1/2 w-[25%] h-[15%] lg:w-[15%] lg:h-[30%] blur-2xl bg-purple rounded-full mix-blend-multiply animate-blob filter opacity-70  animation-delay-6000"></div>
            <div className="absolute top-1/3 right-1/2 w-[25%] h-[15%] lg:w-[25%] lg:h-[50%] blur-2xl bg-yellow rounded-full mix-blend-multiply animate-blob filter opacity-70 animation-delay-9000"></div>
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center gap-6 lg:gap-20">
                ...
                <div className="w-1/2 lg:w-1/3 stack">
